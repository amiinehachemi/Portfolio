  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        {showHandle && (
          <div 
            className="mx-auto mt-3 mb-1 hidden h-1.5 w-12 shrink-0 rounded-full bg-muted-foreground/30 group-data-[vaul-drawer-direction=bottom]/drawer-content:block cursor-grab active:cursor-grabbing" 
            aria-hidden="true"
          />
        )}
        {children}
